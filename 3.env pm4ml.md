...
## Get the jwt token in the tenant env keycloack
select fsps in top left dropdown, select client in left menu, select dfsp-jwt in the list, credential tab , fsp-jwt 
...
https://keycloak.devsw.gtmlabdevsw.mojaloop.live
extapi.devsw.gtmlabdevsw.mojaloop.live
mcm.devsw.gtmlabdevsw.mojaloop.live
