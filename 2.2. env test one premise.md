...
- zm-dev.mojaloop.live
  - dev.zm-dev.mojaloop.live
    - haproxy.dev.zm-dev.mojaloop.live
...
## Internfaces
| hostname | interface | IP               | gateway         | comment          |
| -------- | --------- | ---------------- | --------------- | ---------------- |
| firewall | eth0      | 35.179.230.244   |              NA | firewall net     |
| firewall | eth1      | 10.111.1.254/24  |              NA | firewall loc     |
| bastion  | eth0      | 10.111.1.253/24  | 10.111.1.254/24 |                  |
| proxy    | eth0      | 10.111.1.252/24  | 10.111.1.254/24 | internal gateway |
| proxy    | eth1      | 10.111.1.251/24  | 10.111.1.254/24 | external gateway |
| master-0 | eth0      | 10.111.1.5/24    | 10.111.1.254/24 |                  |
| master-1 | eth0      | 10.111.1.6/24    | 10.111.1.254/24 |                  |
| master-2 | eth0      | 10.111.1.7/24    | 10.111.1.254/24 |                  |
...
the sample configuration files are in /usr/share/doc/shorewall/examples/
...
net     NET_IF          tcpflags,nosmurfs,routefilter,logmartians,sourceroute=0,physical=enX0
loc     LOC_IF          tcpflags,nosmurfs,routefilter,logmartians,routeback,physical=enX1
```
